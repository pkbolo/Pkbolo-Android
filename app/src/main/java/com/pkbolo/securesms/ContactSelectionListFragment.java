...
import com.pkbolo.securesms.contacts.ContactSelectionListAdapter;
import com.pkbolo.securesms.contacts.ContactSelectionListItem;
import com.pkbolo.securesms.contacts.ContactsCursorLoader;
import com.pkbolo.securesms.contacts.SelectedContact;
...
import com.pkbolo.securesms.util.UsernameUtil;
import com.pkbolo.securesms.util.ViewUtil;
import com.pnikosis.materialishprogress.ProgressWheel;

import com.pkbolo.securesms.components.RecyclerViewFastScroller;
...
import com.pkbolo.securesms.util.adapter.FixedViewsAdapter;
import com.pkbolo.securesms.util.adapter.RecyclerViewConcatenateAdapterStickyHeader;
                                                ...
                                                implements LoaderManager.LoaderCallbacks<Cursor>
{
  ...
  public @NonNull Loader<Cursor> onCreateLoader(int id, Bundle args) {
    return new ContactsCursorLoader(getActivity(),
                                    getActivity().getIntent().getIntExtra(DISPLAY_MODE, ContactsCursorLoader.DisplayMode.FLAG_ALL),
