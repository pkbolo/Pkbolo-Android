...
import com.pkbolo.securesms.experienceupgrades.StickersIntroFragment;
                                                  ...
                                                  StickersIntroFragment.Controller
{
  ...
  private static final String DISMISS_ACTION  = "ExperienceUpgradeActivity.DISMISS_ACTION";
  ...
  private enum ExperienceUpgrade {
    SIGNAL_REBRANDING(157,
                      new IntroPagerAdapter.IntroPage(0xFF2090EA,
    ...
    TYPING_INDICATORS(432,
                      ...
                      true),
    LINK_PREVIEWS(449,
                  new IntroPagerAdapter.IntroPage(0xFF2090EA, LinkPreviewsIntroFragment.newInstance()),
                  ...
                  true),
    STICKERS(580,
             new IntroPagerAdapter.IntroPage(0xFF2090EA, StickersIntroFragment.newInstance()),
    ...
    ExperienceUpgrade(int version,
                      @NonNull List<IntroPagerAdapter.IntroPage> pages,
    ...
    ExperienceUpgrade(int version,
                      @NonNull IntroPagerAdapter.IntroPage page,
                      @StringRes int notificationTitle,
                      @StringRes int notificationText,
                      @StringRes int notificationBigText,
                      @Nullable Class nextIntent,
