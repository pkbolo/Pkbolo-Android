...
import com.pkbolo.securesms.avatar.AvatarSelection;
import com.pkbolo.securesms.conversation.ConversationActivity;
...
import com.pkbolo.securesms.contacts.RecipientsEditor;
...
import com.pkbolo.securesms.groups.GroupManager;
...
import com.pkbolo.securesms.util.SelectedRecipientsAdapter;
import com.pkbolo.securesms.util.TextSecurePreferences;
import com.pkbolo.securesms.util.ViewUtil;

import com.pkbolo.securesms.components.PushRecipientsPanel;
import com.pkbolo.securesms.components.PushRecipientsPanel.RecipientsPanelChangedListener;
                                            ...
                                            RecipientsPanelChangedListener
{
  ...
  private class AddRecipientButtonListener implements View.OnClickListener {
    ...
    public void onClick(View v) {
      ...
      if (groupToUpdate.isPresent()) {
        ...
        intent.putExtra(ContactSelectionListFragment.DISPLAY_MODE, ContactsCursorLoader.DisplayMode.FLAG_PUSH | ContactsCursorLoader.DisplayMode.FLAG_SMS);
      }
      startActivityForResult(intent, PICK_CONTACT);
    }
  }

  private static class CreateMmsGroupTask extends AsyncTask<Void,Void, GroupManager.GroupActionResult> {
    ...
    @Override
    protected GroupManager.GroupActionResult doInBackground(Void... avoid) {
    ...
    @Override
    protected void onPostExecute(GroupManager.GroupActionResult result) {
  ...
  private abstract static class SignalGroupTask extends AsyncTask<Void,Void,Optional<GroupManager.GroupActionResult>> {
    ...
    @Override
    protected void onPostExecute(Optional<GroupManager.GroupActionResult> groupActionResultOptional) {
  ...
  private static class FillExistingGroupInfoAsyncTask extends ProgressDialogAsyncTask<String,Void,Optional<GroupData>> {
    ...
    protected Optional<GroupData> doInBackground(String... groupIds) {
      ...
      final Optional<GroupDatabase.GroupRecord> group            = db.getGroup(groupIds[0]);
