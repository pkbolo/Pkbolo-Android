package com.pkbolo.securesms.avatar;
...
import com.pkbolo.securesms.util.IntentUtils;
...
public final class AvatarSelection {
  ...
  private static Intent createAvatarSelectionIntent(Context context, @Nullable File tempCaptureFile, boolean includeClear) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("com.pkbolo.securesms.action.CLEAR_PROFILE_PHOTO"));
    }
