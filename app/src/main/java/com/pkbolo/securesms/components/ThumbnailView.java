...
public class ThumbnailView extends FrameLayout {
  ...
  public ListenableFuture<Boolean> setImageResource(@NonNull GlideRequests glideRequests, @NonNull Uri uri) {
    ...
    GlideRequest request = glideRequests.load(new DecryptableStreamUriLoader.DecryptableUri(uri))
  ...
  private GlideRequest buildThumbnailGlideRequest(@NonNull GlideRequests glideRequests, @NonNull Slide slide) {
    GlideRequest request = applySizing(glideRequests.load(new DecryptableStreamUriLoader.DecryptableUri(slide.getThumbnailUri()))
