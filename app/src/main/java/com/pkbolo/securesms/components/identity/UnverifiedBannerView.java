package com.pkbolo.securesms.components.identity;
...
public class UnverifiedBannerView extends LinearLayout {
  ...
  public void display(@NonNull final String text,
                      @NonNull final List<IdentityDatabase.IdentityRecord> unverifiedIdentities,
  ...
  public interface DismissListener {
    public void onDismissed(List<IdentityDatabase.IdentityRecord> unverifiedIdentities);
  }

  public interface ClickListener {
    public void onClicked(List<IdentityDatabase.IdentityRecord> unverifiedIdentities);
  }
