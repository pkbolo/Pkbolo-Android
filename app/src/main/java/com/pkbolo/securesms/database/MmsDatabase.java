...
import com.pkbolo.securesms.attachments.MmsNotificationAttachment;
import com.pkbolo.securesms.contactshare.Contact;
import com.pkbolo.securesms.database.documents.IdentityKeyMismatch;
import com.pkbolo.securesms.database.documents.IdentityKeyMismatchList;
import com.pkbolo.securesms.database.documents.NetworkFailure;
import com.pkbolo.securesms.database.documents.NetworkFailureList;
...
import com.pkbolo.securesms.database.model.NotificationMmsMessageRecord;
...
import com.pkbolo.securesms.revealable.ViewOnceExpirationInfo;
...
import static com.pkbolo.securesms.contactshare.Contact.Avatar;
...
//  }
  ...
  void trimEntriesForExpiredMessages() {
    SQLiteDatabase database         = databaseHelper.getWritableDatabase();
    String         trimmedCondition = " NOT IN (SELECT " + ID + " FROM " + MmsDatabase.TABLE_NAME + ")";
