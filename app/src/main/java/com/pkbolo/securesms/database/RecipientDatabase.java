                                      ...
                                      @NonNull Collection<StorageSyncHelper.ContactUpdate> updates)
  {
    ...
    try {
      ...
      for (StorageSyncHelper.ContactUpdate update : updates) {
        ...
        try {
          Optional<IdentityDatabase.IdentityRecord> oldIdentityRecord = identityDatabase.getIdentity(recipientId);
          ...
          Optional<IdentityDatabase.IdentityRecord> newIdentityRecord = identityDatabase.getIdentity(recipientId);
