...
public class ThreadDatabase extends Database {
  ...
  public List<MessagingDatabase.MarkedMessageInfo> setRead(long threadId, boolean lastSeen) {
    ...
    final List<MessagingDatabase.MarkedMessageInfo> smsRecords = DatabaseFactory.getSmsDatabase(context).setMessagesRead(threadId);
    final List<MessagingDatabase.MarkedMessageInfo> mmsRecords = DatabaseFactory.getMmsDatabase(context).setMessagesRead(threadId);
