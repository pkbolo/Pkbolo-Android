 ...
 */
package com.pkbolo.securesms.database.model;
...
public class ThreadRecord extends DisplayRecord {
  ...
  private @Nullable final ThreadDatabase.Extra extra;
  ...
  public ThreadRecord(@NonNull String body, @Nullable Uri snippetUri,
                      @Nullable String contentType, @Nullable ThreadDatabase.Extra extra,
  ...
  public SpannableString getDisplayBody(@NonNull Context context) {
    if (isGroupUpdate()) {
      ...
      return emphasisAdded(context.getString(com.pkbolo.securesms.R.string.ThreadRecord_called));
    } else if (SmsDatabase.Types.isIncomingCall(type)) {
      return emphasisAdded(context.getString(com.pkbolo.securesms.R.string.ThreadRecord_called_you));
    } else if (SmsDatabase.Types.isMissedCall(type)) {
      return emphasisAdded(context.getString(com.pkbolo.securesms.R.string.ThreadRecord_missed_call));
