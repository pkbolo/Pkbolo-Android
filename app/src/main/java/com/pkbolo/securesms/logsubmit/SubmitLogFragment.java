...
package com.pkbolo.securesms.logsubmit;
...
import com.pkbolo.securesms.util.BucketInfo;
...
public class SubmitLogFragment extends Fragment {
  ...
  private static CharSequence buildPermissions(@NonNull Context context) {
    ...
    try {
      PackageInfo info = context.getPackageManager().getPackageInfo("com.pkbolo.securesms", PackageManager.GET_PERMISSIONS);
