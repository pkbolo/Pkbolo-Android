...
public class MarkReadReceiver extends BroadcastReceiver {
  ...
  public static final  String CLEAR_ACTION          = "com.pkbolo.securesms.notifications.CLEAR";
  ...
  public static void process(@NonNull Context context, @NonNull List<MessagingDatabase.MarkedMessageInfo> markedReadMessages) {
    ...
    List<MessagingDatabase.SyncMessageId> syncMessageIds = new LinkedList<>();
    ...
    Map<RecipientId, List<MessagingDatabase.SyncMessageId>> recipientIdMap = Stream.of(markedReadMessages)
    ...
    for (Map.Entry<RecipientId, List<MessagingDatabase.SyncMessageId>> entry : recipientIdMap.entrySet()) {
