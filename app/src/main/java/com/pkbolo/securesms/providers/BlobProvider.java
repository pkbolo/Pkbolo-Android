package com.pkbolo.securesms.providers;
...
import com.pkbolo.securesms.video.ByteArrayMediaDataSource;
...
public class BlobProvider {
  ...
  public static final Uri        CONTENT_URI = Uri.parse("content://com.pkbolo.securesms/blob");
  public static final String     AUTHORITY   = "com.pkbolo.securesms";
