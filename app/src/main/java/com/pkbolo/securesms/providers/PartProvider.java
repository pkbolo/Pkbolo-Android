...
import com.pkbolo.securesms.mms.PartUriParser;
import com.pkbolo.securesms.service.KeyCachingService;
import com.pkbolo.securesms.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.pkbolo.provider.securesms/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.pkbolo.provider.securesms", "part/*/#", SINGLE_ROW);
  }
