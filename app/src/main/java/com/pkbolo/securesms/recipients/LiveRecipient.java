...
public final class LiveRecipient {
  ...
  private @NonNull Recipient fetchRecipientFromDisk(RecipientId id) {
    RecipientDatabase.RecipientSettings settings = recipientDatabase.getRecipientSettings(id);
  ...
  private @NonNull RecipientDetails getIndividualRecipientDetails(RecipientDatabase.RecipientSettings settings) {
  ...
  @WorkerThread
  private @NonNull RecipientDetails getGroupRecipientDetails(@NonNull RecipientDatabase.RecipientSettings settings) {
    Optional<GroupDatabase.GroupRecord> groupRecord = groupDatabase.getGroup(settings.getId());
