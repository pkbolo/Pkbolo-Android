...
import com.pkbolo.securesms.contacts.avatars.GroupRecordContactPhoto;
...
import com.pkbolo.securesms.contacts.avatars.SystemContactPhoto;
import com.pkbolo.securesms.contacts.avatars.TransparentContactPhoto;
...
import com.pkbolo.securesms.phonenumbers.PhoneNumberFormatter;
...
public class Recipient {
  ...
  public @NonNull
  RecipientDatabase.VibrateState getMessageVibrate() {
    return messageVibrate;
  }

  public @NonNull
  RecipientDatabase.VibrateState getCallVibrate() {
    return callVibrate;
  }
  ...
  public @NonNull
  RecipientDatabase.RegisteredState getRegistered() {
    if      (isPushGroup()) return RecipientDatabase.RegisteredState.REGISTERED;
    else if (isMmsGroup())  return RecipientDatabase.RegisteredState.NOT_REGISTERED;

    return registered;
  }

  public boolean isRegistered() {
    return registered == RecipientDatabase.RegisteredState.REGISTERED || isPushGroup();
  }
  ...
  public @NonNull
  IdentityDatabase.VerifiedStatus getIdentityVerifiedStatus() {
  ...
  public @NonNull
  RecipientDatabase.UnidentifiedAccessMode getUnidentifiedAccessMode() {
