...
public class RecipientDetails {
  ...
  RecipientDetails(@NonNull Context context,
                   ...
                   @NonNull RecipientDatabase.RecipientSettings settings,
  ...
  RecipientDetails() {
    ...
    this.mutedUntil             = 0;
    this.messageVibrateState    = RecipientDatabase.VibrateState.DEFAULT;
    this.callVibrateState       = RecipientDatabase.VibrateState.DEFAULT;
    this.blocked                = false;
