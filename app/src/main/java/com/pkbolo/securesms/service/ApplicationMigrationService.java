...
import com.pkbolo.securesms.database.SmsMigrator;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "com.pkbolo.securesms.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "com.pkbolo.securesms.ApplicationMigrationService.COMPLETED";
