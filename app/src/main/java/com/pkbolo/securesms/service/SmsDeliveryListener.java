...
public class SmsDeliveryListener extends BroadcastReceiver {
  ...
  public static final String SENT_SMS_ACTION      = "com.pkbolo.securesms.SendReceiveService.SENT_SMS_ACTION";
  public static final String DELIVERED_SMS_ACTION = "com.pkbolo.securesms.SendReceiveService.DELIVERED_SMS_ACTION";
