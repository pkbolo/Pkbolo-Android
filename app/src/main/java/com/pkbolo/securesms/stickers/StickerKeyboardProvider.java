...
import com.pkbolo.securesms.components.emoji.MediaKeyboardProvider;
...
import com.pkbolo.securesms.stickers.StickerKeyboardRepository.PackListResult;
import com.pkbolo.securesms.util.ResUtil;
import com.pkbolo.securesms.util.ThemeUtil;
import com.pkbolo.securesms.util.Throttler;
                                                ...
                                                StickerKeyboardPageFragment.EventListener
{
  ...
  private static class StickerPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public StickerPagerAdapter(@NonNull FragmentManager fm, @NonNull StickerKeyboardPageFragment.EventListener eventListener) {
      super(fm);
      this.eventListener = eventListener;
