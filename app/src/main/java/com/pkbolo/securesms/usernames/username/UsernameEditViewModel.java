package com.pkbolo.securesms.usernames.username;
...
import com.pkbolo.securesms.util.SingleLiveEvent;
...
class UsernameEditViewModel extends ViewModel {
  ...
  void onUsernameUpdated(@NonNull String username) {
    ...
    Optional<UsernameUtil.InvalidReason> invalidReason = UsernameUtil.checkUsername(username);
  ...
  private static UsernameStatus mapUsernameError(@NonNull UsernameUtil.InvalidReason invalidReason) {
